...
layui.define(['layer', 'laytpl', 'form', 'upload', 'util'], function(exports){
  ...
  $("#header-login").bind("click", function () {
  	$("#content").load("/User/Login", { }, function () {
  		//alert("提交成功");
  	});
  	$("#content").removeClass("fly-user-main");
  });
  $("#header-regist").bind("click", function () {
  	$("#content").load("/User/Set", {}, function () {
  		//alert("提交成功");
  	});
  	$("#content").addClass("fly-user-main");
  });
  exports('fly', gather);
